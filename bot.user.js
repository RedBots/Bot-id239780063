...
function getLatestCommit() {
    window.jQuery.ajax({
            ...
            $.get('https://raw.githubusercontent.com/redbots/Bot-id239780063/master/bot.user.js?' + Math.floor((Math.random() * 1000000) + 1), function(data) {
                ...
                {
                    update("rednelssBot", "bot.user.js", "https://github.com/redbots/Bot-id201137753/blob/" + sha + "/bot.user.js/");
                }
...
function rednelssBot() {
    this.name = "rednelssBot " + rednelssBotVersion;
...
window.botList.push(new rednelssBot());
